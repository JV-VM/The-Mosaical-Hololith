...
- Evidence: `apps/api/src/analytics/dto/track-view.dto.ts:3`
- Evidence: `apps/api/src/analytics/dto/track-view.dto.ts:4`
- Evidence: `apps/api/src/analytics/dto/track-view.dto.ts:7`
- Evidence: `apps/api/src/analytics/dto/track-view.dto.ts:15`

2) TrackBatchDto payload shape
- `events` is an array of `TrackViewDto` with max size 50.
- Evidence: `apps/api/src/analytics/dto/track-batch.dto.ts:5`
- Evidence: `apps/api/src/analytics/dto/track-batch.dto.ts:7`
- Evidence: `apps/api/src/analytics/dto/track-batch.dto.ts:10`

3) Validation of view types and required IDs
- Service must reject non-view types and missing IDs for the selected type.
- Evidence: `apps/api/src/analytics/analytics.service.ts:59`
- Evidence: `apps/api/src/analytics/analytics.service.ts:62`
- Evidence: `apps/api/src/analytics/analytics.service.ts:65`
- Evidence: `apps/api/src/analytics/analytics.service.ts:68`
...
- Evidence: `apps/api/src/analytics/analytics.service.ts:139`
- Evidence: `apps/api/src/analytics/analytics.service.ts:182`
- Evidence: `apps/api/src/analytics/analytics.service.ts:184`
- Evidence: `apps/api/src/analytics/analytics.service.ts:194`
...
- Evidence: `apps/api/src/analytics/analytics.ts:19`
- Evidence: `apps/api/src/analytics/analytics.ts:21`
- Evidence: `apps/api/src/analytics/analytics.ts:33`
- Evidence: `apps/api/src/analytics/analytics.ts:44`
- Evidence: `apps/api/src/analytics/analytics.ts:58`
...
- Evidence: `apps/api/src/analytics/analytics.service.ts:59`
- Evidence: `apps/api/src/analytics/analytics.service.ts:175`
- Evidence: `apps/api/src/analytics/analytics.ts:33`
...
- Async directly inside `setTimeout` or double scheduling delays.
  ...
  - Evidence: `apps/api/src/analytics/analytics.ts:25`
  - Evidence: `apps/api/src/analytics/analytics.ts:33`
- Duplicated `OR` blocks per type in queries.
  - Use `TENANT_WHERE_BY_TYPE` map to generate filters.
  - Evidence: `apps/api/src/analytics/analytics.service.ts:47`
  - Evidence: `apps/api/src/analytics/analytics.service.ts:241`
