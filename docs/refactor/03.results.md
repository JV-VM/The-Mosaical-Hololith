...
- Evidence: `apps/api/src/auth/auth.service.ts:17`
- Evidence: `apps/api/src/auth/auth.service.ts:81`
- Evidence: `apps/api/src/auth/auth.service.ts:89`

1.2 Consolidate auth response assembly
- Done: `register`, `login`, `refresh` call `issueTokensAndPersist`.
- Evidence: `apps/api/src/auth/auth.service.ts:36`
- Evidence: `apps/api/src/auth/auth.service.ts:45`
- Evidence: `apps/api/src/auth/auth.service.ts:54`
- Evidence: `apps/api/src/auth/auth.service.ts:98`
...
- Changes limited to authorized files: yes (`apps/api/src/auth/auth.service.ts` only).
...
- Evidence: `apps/api/src/catalog/catalog.service.ts:93`
- Evidence: `apps/api/src/catalog/catalog.service.ts:235`
- Evidence: `apps/api/src/catalog/catalog.service.ts:251`
...
- 3-indentation rule applied: yes (verified in touched blocks).
- Lint/TS ok: not run in this pass.
- Changes limited to authorized files: yes (`apps/api/src/catalog/catalog.service.ts` only).
